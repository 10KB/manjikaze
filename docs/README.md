# Manjikaze Documentation

Welcome to the Manjikaze documentation. This guide will help you understand and use Manjikaze effectively.
...
- [Using Manjikaze](getting-started/using-manjikaze.md)

### [Features](features/README.md)

- [Navigation and hotkeys](features/navigation.md)
- [Tiling](features/tiling.md)
